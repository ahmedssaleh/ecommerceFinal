        ...
        <div class="container">
                    ...
                    @if (isset($prod))
                        @foreach ($prod as $index => $pro)
                            ...
                            <div class="item-slide">
                                <img src="{{ asset('image_producte/' . $pro->photo) }}" alt="{{ $pro->name }}"
                                    width="1170" height="240" class="img-slide .h-20  .w-20">
                        ...
                        @foreach ($producte as $product)
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('show.producte', $product->id) }}"
                                        title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="{{ asset('image_producte/' . $product->photo) }}" width="800"
                                    ...
                                    <div class="wrap-btn">
                                        <a href="{{ route('show.producte', $product->id) }}" class="function-link">quick
                                            view</a>
                                    </div>
                                </div>
            ...
            <div class="wrap-show-advance-info-box style-1">
                ...
                <div class="wrap-top-banner">
                    <a href="{{ route('show.producte', $product->id) }}" class="link-banner banner-effect-2">
                        <figure><img src="{{ asset('image_producte/' . $product->photo) }}" width="1170" height="0"
                        ...
                        <div class="tab-contents">
                                ...
                                <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                    ...
                                    @if (isset($producte1))
                                        @foreach ($producte1 as $index => $prod1)
                                            <div class="product product-style-2 equal-elem ">
                                                <div class="product-thumnail">
                                                    <a href="{{ route('show.producte', $prod1->id) }}"
                                                        title="{{ $prod1->name }}">
                                                        <figure><img src="{{ asset('image_producte/' . $prod1->photo) }}"
                                                                width="800" height="800" alt="{{ $prod1->name }}">
                                                        </figure>
                                                    </a>
                                                    <div class="group-flash">
                                                ...
                                                <div class="product-info">
                                                    <a href="{{ route('show.producte', $prod1->id) }}"
                                                        class="product-name"><span>{{ $prod1->contact }}</span></a>
                                                    <div class="wrap-price"><span
                                                            class="product-price">${{ $prod1->price }}</span></div>
                                                </div>
                                            </div>
                            ...
                            <div class="wrap-top-banner">
                                <a href="{{ route('show.producte', $prod1->id) }}" class="link-banner banner-effect-2">
                                    <figure><img src="{{ asset('image_producte/' . $prod1->photo) }}" width="1170"
                                            ...
                                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                                ...
                                                @if (isset($subcat->producte))
                                                    @foreach ($subcat->producte as $index => $item)
                                                        <div class="product product-style-2 equal-elem ">
                                                            <div class="product-thumnail">
                                                                <a href="{{ route('show.producte', $item->id) }}"
                                                                    title="{{ $item->name }}">
                                                                    <figure><img
                                                                            src="{{ asset('image_producte/' . $item->photo) }}"
