                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> اسم القسم
                                                                        {{ __('message.' . $lang->abbr) }} </label>
                                                                    <input type="text" value="" id="name"
                                                                        class="form-control"
                                                                        name="caegory[{{ $index }}][name]">
                                                                    @error("caegory.$index.name")
                                                            ...
                                                            <div class="col-md-6 hidden">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="{{ $lang->abbr }}" id="name"
                                                                        class="form-control"
                                                                        name="caegory[{{ $index }}][translation_lang]">
                                                                    @error("caegory.$index.translation_lang")
                                                                        <span class="text-danger">هذا الحقل مطلوب</span>
                                                                    @enderror
